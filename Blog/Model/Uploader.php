...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH = 'emakinablog/tmp/images/image/';
    /**
     * @var string
     */
    const IMAGE_PATH = 'emakinablog/images/image/';
    /**
     * @var string
     */
    const FILE_TMP_PATH = 'emakinablog/tmp/images/file/';
    /**
     * @var string
     */
    const FILE_PATH = 'emakinablog/images/file/';
